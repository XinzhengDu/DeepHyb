...
# Set font configuration for bold text
...
# 1. Construct data
# Data contains SHAP value %s for different patterns across 9 models
data = {
    "legend": [
        "Model 1", "Model 2", 
        "Model 3", "Model 4", 
...
plt.xlabel("Pattern ", fontsize=12, fontweight='bold')
